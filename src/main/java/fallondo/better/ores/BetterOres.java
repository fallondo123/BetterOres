...
public class BetterOres implements ModInitializer {
	...
	public static final Item STEEL_MATERIAL_HELMET = new ArmorItem(STEEL_ARMOR_MATERIAL, EquipmentSlot.HEAD,
			new Item.Settings().group(ItemGroup.COMBAT));
	public static final Item STEEL_MATERIAL_CHESTPLATE = new ArmorItem(STEEL_ARMOR_MATERIAL, EquipmentSlot.CHEST,
			new Item.Settings().group(ItemGroup.COMBAT));
	public static final Item STEEL_MATERIAL_LEGGINGS = new ArmorItem(STEEL_ARMOR_MATERIAL, EquipmentSlot.LEGS,
			new Item.Settings().group(ItemGroup.COMBAT));
	public static final Item STEEL_MATERIAL_BOOTS = new ArmorItem(STEEL_ARMOR_MATERIAL, EquipmentSlot.FEET,
			new Item.Settings().group(ItemGroup.COMBAT));
	...
	// Sulfur
	public static final Item SULFUR = new Sulfur(new Item.Settings().group(ItemGroup.MATERIALS));
	...
	public void onInitialize() {
		...
		Registry.register(Registry.ITEM, new Identifier("betterores", "steel_material_helmet"),
				STEEL_MATERIAL_HELMET);
		Registry.register(Registry.ITEM, new Identifier("betterores", "steel_material_chestplate"),
				STEEL_MATERIAL_CHESTPLATE);
		Registry.register(Registry.ITEM, new Identifier("betterores", "steel_material_leggings"),
				STEEL_MATERIAL_LEGGINGS);
		Registry.register(Registry.ITEM, new Identifier("betterores", "steel_material_boots"),
		...
		BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES,
				oreRubyOverworld);
		BiomeModifications.addFeature(BiomeSelectors.categories(Biome.Category.JUNGLE), GenerationStep.Feature.UNDERGROUND_ORES,
				orePainiteOverworld);
		BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES,
				oreMithrilOverworld);
		BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES,
